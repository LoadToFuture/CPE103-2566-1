#include <stdio.h>
extern int summation(int m, int n);
extern int product(int m, int n);
extern float Poly2(float a2, float a1, float a0, float x);
extern float maxFloat(float data[], int n);
int main()
{
    int menu = 1;
    do
